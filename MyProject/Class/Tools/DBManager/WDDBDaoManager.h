...
/// 数据库操作对象
@interface WDDBDaoManager : NSObject
...
/// 数据库删除操作分类
@interface WDDBDaoManager (Delete)
/// 删除数据库中所有的表格
- (void)dropAllTable;
...
/// 数据库插入数据操作分类
@interface WDDBDaoManager (Insert)
...
@interface WDDBDaoManager (Update)
...
/// 数据库查询数据操作分类
@interface WDDBDaoManager (Search);
