...
//用法
//    NSString *enc = [RSA encryptString:@"12345" publicKey:pubkey];
+ (NSString *)rsaPassword:(NSString *)passwrod {
    passwrod = [RSA encryptString:passwrod publicKey:PUBKEY];
    
    //passwrod = [RSA encryptString: passwrod publicKey: PUBKEY];

   // passwrod = [RSA encodeURL: passwrod];
    return passwrod;
}
